        ...
        <div className="flex px-4 md:px-[120px] gap-x-24 mt-9 items-start">
          ...
          <div className="font-medium">
            ...
            <p className="text-xl mt-9">
              ...
              and receptive. Our platform catalyzes authentic engagement and is
              designed to align your business or personal brand with vibrant
              community hubs and interaction spaces.
            </p>
            <p className="text-xl mt-9">
              Whether you're a startup seeking visibility, a marketer aiming for
              impact, or a brand looking to resonate with your audience,
              ...
              engagement truly happens, we empower businesses to broadcast their
              messages and initiate conversations, build relationships, and
              foster communities around their offerings. Pigeonhire is a
        ...
        <div className="flex px-4 md:px-[120px] gap-x-24 mt-9 items-start">
          <div className="font-medium">
            <p className="text-xl mt-2">
              ...
              meaningful and impactful way, fostering genuine relationships and
          ...
          <div className="font-medium">
            <ul className="text-xl mt-2 list-disc">
              ...
              <li className="mb-2">
                ...
                forefront of connecting businesses with communities in impactful
                ways.
              </li>
              <li className="mb-2">
                {" "}
                Growth: We are dedicated to developing our users, communities,
                and platform, ensuring that every connection made on Pigeonhire
                is a step toward collective success.
              </li>
            </ul>
          </div>
          <img src={frame3} className="object-contain rounded-b-2xl" />
