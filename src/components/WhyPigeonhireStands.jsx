...
const WhyPigeonhireStands = () => {
  return (
    ...
    <p className='text-center text-4xl font-bold'>Why Pigeonhire Stands Out</p>

    <div className='grid grid-cols-4 gap-y-12 mt-12'>

        <div className='bg-[#F7F7F7] py-4 px-4 max-w-[220px]'>
        <AiOutlineGlobal size={25} color='#F08E1F'/>
        <p className='font-semibold mt-2'>Local and Global Reach</p>
        ...
        <div className='bg-[#F7F7F7] py-4 px-4 max-w-[250px]'>
...
export default WhyPigeonhireStands