...
const HowBusinessThrive = () => {
  ...
  <div className='py-9 bg-white px-4 md:px-[120px]'>
        <p className='text-center text-4xl font-bold'>How businesses are thriving using</p>
        <p className='text-center text-4xl font-bold'>Pigeonhire</p>
...
<div className='max-w-[350px]'>
    ...
    <p className='text-gray-700 text-md mt-2 tracking-wide'>Our partnership with Pigeonhire during our campus ambassador program was a game-changer. The access to a wide array of communities resulted in unprecedented engagement and sales.</p>
    <p className='text-[#F08E1F] flex gap-x-2 items-center'>Boost your market and brand visibility <BsArrowRight color='#F08E1F'/></p>
</div>
<div className='max-w-[350px] mt-9'>
    <img src={people} className='object-contain h-12 w-[50px]'/>
    <p className='text-gray-700 text-md mt-2'>As a community leader, the PAYG model has been transformative. We've partnered with businesses that truly resonate with our audience, enhancing both our community's value and our collaboration</p>
    <p className='text-[#F08E1F] flex gap-x-2 items-center'>Get connected to your tribe  <BsArrowRight color='#F08E1F'/></p>
</div>
</div>
