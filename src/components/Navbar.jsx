...
<div className='flex gap-6 mr-64'>
        <p className='text-[#201327] text-xl font-light'>pricing</p>
        <p className='text-[#201327] text-xl font-light'>Explore Communities</p>
        <p className='text-[#201327] text-xl font-light'>Community Owners</p>
        </div>
        

<div className='flex gap-1 items-center px-6'>
        <p className='text-[#201327] text-xl font-bold'>login </p>
        <RiArrowDownSLine size={25} className='pt-1'/>
        </div>
