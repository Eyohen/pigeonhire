    ...
    <div>
      ...
      <div className="w-full max-w-[1352px] px-5 mx-auto py-20">
        ...
        <Image
          ...
          <div className="mb-2">
            <h2 className="text-2xl font-normal leading-[140%] mb-8">
...
<h1 className="text-[32px] font-semibold mb-6">Data security</h1>
<p className="text-lg text-gray leading-[140%] mb-4">
...
<h1 className="text-[32px] font-semibold mb-6">Data retention</h1>
<p className="text-lg text-gray leading-[140%] mb-4">
...
<h1 className="text-[32px] font-semibold mb-6">Third-Party links</h1>
<p className="text-lg text-gray leading-[140%] mb-4">Our Services may contain links to third-party websites. We are not responsible for the privacy practices or content of these websites. We encourage you to review the privacy policies of any third-party sites you visit.</p>
<h2 className="text-2xl font-normal leading-[140%] mb-8">We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new policy on our website. Your continued use of our Services after any changes constitutes your acceptance of the new Privacy Policy.</h2>
<h2 className="text-2xl font-normal leading-[140%] mb-8">If you have any questions about this Privacy Policy, please contact us at:  Email: hello@pigeonhire.com</h2>
                  </div>
      </div>
