    ...
    return (
        <div className="w-full max-w-[1079px] h-[58px] border border-[#E5E5E5] rounded-[48px] flex items-center px-4 mx-auto my-6 bg-white shadow-sm hover:border-gray-300 transition-colors">
            ...
            <input
                ...
                className="w-full ml-2 mr-2.5 border-none text-base outline-none bg-transparent"
            />
            ...
            <select name="" id="" className="text-base text-[#8D8D8D] border-none outline-none bg-transparent cursor-pointer">
